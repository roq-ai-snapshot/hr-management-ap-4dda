  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your business with HR Management Application, streamlining HR tasks for efficiency and ease, transforming human resources for a digital world."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your business with HR Management Application, streamlining HR tasks for efficiency and ease, transforming human resources for a digital world.`}
            </Text>
            <Box
